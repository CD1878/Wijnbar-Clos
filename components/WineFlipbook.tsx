...
const wineData = [
    {
        title: "Mousserend",
        wines: [
            { name: "Cava Brut 'Reserva'", grapes: "Macabeo, Xarel-lo, Parellada", vintage: "NV", priceGlass: 7.5, priceBottle: 39.5 },
            { name: "Champagne Blanc de Blancs", grapes: "Chardonnay", vintage: "NV", priceGlass: 14.5, priceBottle: 79.5 }
        ]
    },
    {
        title: "Wit",
        wines: [
            { name: "Verdejo", grapes: "Verdejo", vintage: "2023", priceGlass: 6.5, priceBottle: 32.5 },
            { name: "Chardonnay 'Reserve'", grapes: "Chardonnay", vintage: "2022", priceGlass: 8.5, priceBottle: 42.5 }
        ]
    },
    {
        title: "Rood",
        wines: [
            { name: "Pinot Noir", grapes: "Pinot Noir", vintage: "2022", priceGlass: 7.5, priceBottle: 37.5 },
            { name: "Rioja Crianza", grapes: "Tempranillo", vintage: "2020", priceGlass: 8.0, priceBottle: 39.5 }
        ]
    }
];
            ...
            >
                ...
                <Page className="bg-[#fafaf9]">
                    <div className="h-full flex flex-col items-center justify-center border-4 border-double border-brand-green-dark/20 m-4">
                        ...
                        <h1 className="font-display text-4xl text-brand-green-dark tracking-[0.3em] mb-4">Wijnkaart</h1>
                    ...
                    return chunks.map((chunk, chunkIndex) => (
                        <Page key={`${category.title}-${chunkIndex}`}>
                            <div className="h-full flex flex-col">
                                <h3 className="font-display text-2xl text-brand-green-dark mb-6 tracking-widest text-center border-b border-brand-contrast/30 pb-4">
                ...
                <Page className="bg-[#fafaf9]">
                    <div className="h-full flex flex-col items-center justify-center">
                        <h3 className="font-display text-xl text-brand-green-dark tracking-widest mb-2">Wijnbar Clos</h3>
