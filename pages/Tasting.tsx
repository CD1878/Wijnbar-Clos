    ...
    <div className="min-h-screen pt-32 pb-24 px-6 fade-in bg-brand-cream/30 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        <div className="order-2 lg:order-1 lg:sticky lg:top-32">
          <h1 className="font-display text-5xl md:text-6xl text-brand-dark mb-12 drop-shadow-sm">Wijnproeven</h1>
          ...
          <div className="space-y-16">
            <div className="glass p-8 border border-white/20 shadow-lg bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-colors duration-500">
              <h3 className="font-display text-2xl text-brand-dark mb-4 uppercase tracking-wider">High Wine</h3>
              ...
              <div className="flex flex-wrap gap-3">
                <Button variant="primary" className="text-xs py-3 px-4 uppercase tracking-widest">
                  Reserveer 3 Gangen
                </Button>
                <Button variant="primary" className="text-xs py-3 px-4 uppercase tracking-widest">
                  Reserveer 4 Gangen
          ...
          <div className="mt-12 rounded-none overflow-hidden h-[300px] shadow-xl relative group">
            <img
        ...
        {/* Form Side */}
        <div className="order-1 lg:order-2 glass p-10 md:p-12 border border-white/20 shadow-2xl backdrop-blur-md bg-white/20">
          <h3 className="font-display text-3xl text-brand-dark mb-8">Reserveer een proeverij</h3>
          <form className="flex flex-col">
            ...
            <div className="flex flex-col mb-6 gap-2">
              <label htmlFor="type" className="font-display text-brand-dark text-sm tracking-widest uppercase">Type Proeverij</label>
