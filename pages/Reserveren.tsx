...
export const Reserveren: React.FC = () => {
 ...
 <div className="max-w-4xl mx-auto px-6 pb-24 text-[#370028]">
 ...
 <p className="font-serif text-lg mb-8 italic text-brand-grey">
 Wil je vandaag nog langskomen? Bel ons voor de actuele beschikbaarheid.
 <span className="block mt-2 font-sans not-italic">
 <a href="tel:0207733043" className="inline-flex items-center gap-2 text-[#370028] hover:text-white transition-colors">
 <Phone size={18} />
 020-7733043
 </a>
 </span>
 </p>
 <a href="#reserve" className="inline-block border border-[#744365] bg-brand-contrast text-[#FBF9F6] px-10 py-4 font-sans font-bold tracking-[0.2em] hover:opacity-80 hover:border-[#370028] hover:text-[#FBF9F6] transition-colors shadow-lg">
 Direct Reserveren
 </a>
 </div>
 ...
 <div className="bg-brand-contrast p-4 text-[#FBF9F6] rounded-full shrink-0">
 <Users size={32} />
 </div>
 <div>
 <h2 className="font-sans text-2xl font-bold tracking-widest text-[#370028] mb-4">Ben je met een groep?</h2>
 ...
 <p className="font-sans font-bold tracking-widest mb-8 text-[#370028]">
 Schuif aan.
 </p>
 <Link
 to="/contact"
 className="inline-block border border-[#744365] bg-brand-contrast text-[#FBF9F6] px-10 py-4 font-sans font-bold tracking-[0.2em] hover:opacity-80 hover:border-[#370028] hover:text-[#FBF9F6] transition-colors shadow-lg"
 >
 Groepsreservering
 </Link>
 </div>
